    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const pendingProjects = projetsEnAttente.length;
                    ...
                    datasets: [
                        {
                            ...
                            data: [
                                ...
                                inProgressProjects,
                                pendingProjects,
                            ], // lateProjects → pendingProjects
                            backgroundColor: [
                                "rgba(75, 192, 192, 0.6)", // Terminés (vert)
                                "rgba(54, 162, 235, 0.6)", // En cours (bleu)
                                "rgba(255, 159, 64, 0.6)", // En attente (orange)
                            ],
                            borderWidth: 1,
                        },
                    ],
                ...
                setStats([
                    ...
                    },
                    {
                        ...
                        value: [
                            ...new Set(
                                projectsData.flatMap((p) => p.technologie || [])
                            ),
                        ].length.toString(),
                ...
                setEnAttente(
                    projetsEnAttente.map((p) => p.titre || "Projet sans nom")
                );
            } catch (err) {
