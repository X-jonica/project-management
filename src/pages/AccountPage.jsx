  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        const userData = { nom, email, role: role || "user", dateCreation };
            ...
            <div className="p-8">
              <div className="flex items-center mb-8">
                <div className="w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold mr-6">
                  {userData.nom?.charAt(0)?.toUpperCase() || <FaUserCircle />}
                </div>
                <div>
                  {editMode ? (
                    <input
                    ...
                    <h3 className="text-xl font-semibold">{userData.nom}</h3>
                  )}
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      {editMode ? (
                        ...
                        <p className="text-gray-800">{userData.nom}</p>
                      )}
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-500 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800">
                        {new Date(
                          userData.dateCreation || new Date()
                        ).toLocaleDateString()}
                      </p>
                    </div>
                  </div>
